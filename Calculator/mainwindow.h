...
private:
    ...
    unsigned countHistory; // Счетчик истории
    /*Переменные для операций*/
    bool operation; // Для определения операции
...
private slots:
    ...
    void on_pushButton_point_clicked(); // Установка запятой в чисое
    void on_pushButton_clear_clicked(); // Очистка поля C
    void on_pushButton_clean_entry_clicked(); // CE
    ...
    void on_pushButton_fact_clicked(); // Факториал
    ...
    /*Другое*/
    void on_action_triggered(); // Выражение
};
#endif // MAINWINDOW_H
